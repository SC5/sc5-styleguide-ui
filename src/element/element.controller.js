angular.module('sc5.styleguide.element', [
  'sc5.styleguide.markup.addWrapper',
  'sc5.styleguide.markup.unsafe',
  'sc5.styleguide.variable.filterRelated',
  'sc5.styleguide.variable.setVariables'
]).controller('ElementController', function($scope, $rootScope, $stateParams, Styleguide, Variables, $filter) {
