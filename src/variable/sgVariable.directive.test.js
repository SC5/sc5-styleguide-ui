describe('directive: sc5.styleguide.variable.sgVariable', function() {

  'use strict';

  var $scope, elem, html;

  beforeEach(module('sc5.styleguide.variable.sgVariable'));

  beforeEach(module(function($provide) {
    $provide.value('Styleguide', {});
    $provide.value('Variables', { init: function() {} });
  }));
  ...
  beforeEach(function() {
    ...
    inject(function($compile, $rootScope, $templateCache) {
      $templateCache.put('variable/sgVariable.html', '<div></div>');
      $scope = $rootScope.$new();
      $scope.variable = {
        value: '#000000'
      };
