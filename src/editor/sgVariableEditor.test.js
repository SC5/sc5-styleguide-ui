describe('directive: sc5.styleguide.editor.sgVariableEditor', function() {
  var $scope, elem, html, variables;

  beforeEach(module('sc5.styleguide.editor'));
  ...
  beforeEach(function() {
    html = '<div sg-variable-editor></div>';

    inject(function($compile, $rootScope, $templateCache) {
      $templateCache.put('editor/sgVariableEditor.html', '<div></div>');
      $scope = $rootScope.$new();
